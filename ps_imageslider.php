...
class Ps_ImageSlider extends Module implements WidgetInterface
{
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            ...
            foreach ($languages as $language) {
                ...
                if (
                    isset($_FILES['image_mobile_' . $language['id_lang']]) &&
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            ...
            if(isset($slide['image_mobile_url']))
                $slide['image_mobile_url'] = $this->context->link->getMediaLink(_MODULE_DIR_ . 'ps_imageslider/images/' . $slide['image_mobile']);
            else
                $slide['image_mobile_url'] = $this->context->link->getMediaLink(_MODULE_DIR_ . 'ps_imageslider/images/' . $slide['image']);
    ...
    public function getSlides2($active = null)
    {
        $this->context = Context::getContext();
        $id_shop = $this->context->shop->id;
        $id_lang = $this->context->language->id;
        ...
        foreach ($slides as &$slide) {
            ...
            if (isset($slide['image_mobile']) && !empty($slide['image_mobile']))
                $slide['image_mobile_url'] = $this->context->link->getMediaLink(_MODULE_DIR_ . 'ps_imageslider/images/' . $slide['image_mobile']);
            else
                $slide['image_mobile_url'] = $this->context->link->getMediaLink(_MODULE_DIR_ . 'ps_imageslider/images/' . $slide['image']);
            $slide['url'] = $this->updateUrl($slide['url']);
    ...
    public function getAllImagesBySlidesId($id_slides, $active = null, $id_shop = null)
    {
        ...
        foreach ($results as $result) {
            ...
            $images[$result['id_lang']]['mobile'] = $result['image_mobile'];
        }
    ...
    public function renderAddForm()
    {
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'required' => false,
                        'lang' => true,
                        'desc' => $this->getTranslator()->trans('Maximum image mobile size: %s.', [ini_get('upload_max_filesize')], 'Admin.Global'),
                    ],
                    [
                        'type' => 'text',
        ...
        if (Tools::isSubmit('id_slide') && $this->slideExists((int) Tools::getValue('id_slide'))) {
            ...
            $fields_form['form']['images']['desktop'] = $slide->image;
            $fields_form['form']['images']['mobile'] = $slide->image_mobile;
            ...
            foreach (Language::getLanguages(false) as $lang) {
                ...
                // if (!isset($slide->image_moblie[$lang['id_lang']])) {
                //     $has_picture &= false;
                // }
            }
